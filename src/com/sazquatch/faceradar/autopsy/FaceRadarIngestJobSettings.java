...
public class FaceRadarIngestJobSettings implements IngestModuleIngestJobSettings {

    private static final long serialVersionUID = 1L;
    private boolean skipKnownFiles = true;

    FaceRadarIngestJobSettings() {
    }

    FaceRadarIngestJobSettings(boolean skipKnownFiles) {
